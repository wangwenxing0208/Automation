...
class PartyB(BrowserDriver):
    ...
    listPartyB1_loc = (By.XPATH, '//*[@id="grid_buoyancyfactorlist_content_tbody"]/tr[1]/td[2]/div')
    ...
    @property
    def listPartyB1(self):
        return self.get_text(self.listPartyB1_loc)